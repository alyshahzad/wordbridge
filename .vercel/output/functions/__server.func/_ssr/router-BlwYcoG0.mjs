...
import { o as todayKey, s as yesterdayKey } from "./utils-C95xt6KI.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/articles-Ce3TQp_O.js
var articles = [
	{
		id: "city-parks",
		title: "The Quiet Return of City Parks",
		description: "How neglected urban green space became a practical tool for cooler, healthier neighborhoods.",
...
The most interesting shift was social. Parks became a {{sanctuary}} in neighborhoods that had little private outdoor space. Local groups offered to {{steward}} the plantings after the contractors left. The city still owns the land, but the care is shared. That may be the quiet lesson: green space lasts when people have a reason to keep returning.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The article says planners noticed neighborhoods with tree cover stayed cooler and were used more after heat waves."
		}, {
			id: "city-parks-q2",
			...
			correctIndex: 2,
			explanation: "The closing argument is that parks last when people keep returning and help steward them."
		}]
	},
	{
		id: "reliable-software",
		title: "How Small Teams Build Reliable Software",
		description: "Reliability is less a heroic all-nighter than a habit of noticing problems early.",
		category: "Technology",
...
Reliability, in this sense, is a social skill. It is the habit of making problems visible while they are still cheap.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The passage argues that small changes hide fewer mistakes and are easier to reverse than large rewrites."
		}, {
			...
			correctIndex: 2,
			explanation: "Observability is described as a way for a small team to see what the product is doing in real use."
		}]
	},
	{
		id: "sleep-memory",
		title: "The Science of Sleep and Memory",
		description: "Sleep is not empty time. It is one of the brain’s most reliable study partners.",
		category: "Science",
		difficulty: "intermediate",
		readingTime: 6,
...
None of this suggests that effort is unimportant. It suggests that effort has a partner. Sleep does not invent knowledge, but it does {{restore}} the conditions under which knowledge can stay. For university work, that may be the least glamorous advantage available — and one of the most reliable.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The article describes overnight replay that consolidates traces into longer-term networks."
		}, {
			id: "sleep-memory-q2",
			...
			correctIndex: 1,
			explanation: "Deprivation weakens attention and retention, so extra waking hours are often spent relearning."
		}]
	},
	{
		id: "street-food",
		title: "Street Food as Cultural Archive",
		description: "A stall can hold a family’s history more clearly than a museum label.",
		category: "Culture",
		difficulty: "beginner",
		readingTime: 5,
		author: "Rina Sari",
...
If those stalls vanish, a city does not only lose cheap meals. It loses an archive that was never written down. The record lived in muscle memory: how long to fry the shallots, how much lime is enough, which customers still want the old heat.`,
		comprehension: [{
			...
			correctIndex: 0,
			explanation: "The essay treats stalls as an archive — memory held in recipes and habits rather than behind glass."
		}, {
			id: "street-food-q2",
			...
			correctIndex: 1,
			explanation: "In diaspora neighborhoods, stalls act as a map back to a palate and kitchen that may no longer be nearby."
		}]
	},
	{
		id: "public-libraries",
		title: "Why Public Libraries Still Matter",
		description: "A library is one of the last indoor places that asks almost nothing of you except curiosity.",
		category: "Education",
		difficulty: "beginner",
		readingTime: 5,
		author: "Helen Park",
...
People sometimes ask whether libraries are outdated because phones can hold a thousand titles. The better question is whether a city still wants a place where attention is not being sold. If the answer is yes, the library is not a leftover. It is infrastructure for thinking.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The essay argues that access — books, computers, quiet — is the product, not a purchase."
		}, {
			...
			correctIndex: 1,
			explanation: "The closing argument is that cities still need a place where attention is not a product."
		}]
	},
	{
		id: "economics-attention",
		title: "The Economics of Attention",
		description: "If a product is free, the scarce resource being spent may be your focus.",
		category: "Society",
		difficulty: "advanced",
		readingTime: 7,
		author: "Sofia Grant",
...
None of this requires a moral panic about technology. It requires a more adult accounting. If attention is the resource, then the question is not only what a product costs in money. It is what it costs in the kind of mind you still have at 4 p.m.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The opening argument is that attention is scarce because the day is finite while claims on it have grown."
		}, {
			...
			correctIndex: 0,
			explanation: "The essay says few people dig through settings, so defaults quietly determine behavior."
		}]
	},
	{
		id: "coral-reefs",
		title: "Coral Reefs After Heat Waves",
		description: "Reefs can recover from heat, but only if the next shock arrives late enough.",
		category: "Environment",
		difficulty: "intermediate",
		readingTime: 6,
		author: "Daniel Okoye",
...
Hope, in this field, is timed. It is the gap between shocks. Policy that lengthens that gap — even slightly — is not optimism as a mood. It is engineering for a living structure that still knows how to heal.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "Warm water breaks the symbiotic relationship; algae leave and the coral turns white."
		}, {
			id: "coral-reefs-q2",
			...
			correctIndex: 1,
			explanation: "Local stress reduction does not halt warming, but it improves the chance of recovery when water cools."
		}]
	},
	{
		id: "walkable-cities",
		title: "What Makes a City Walkable",
		description: "Walkability is not a lifestyle brand. It is a set of distances, shade, and reasons to stop.",
		category: "Society",
		difficulty: "intermediate",
		readingTime: 6,
		author: "Luis Navarro",
...
When the parts align, a district becomes more {{livable}} without asking residents to become athletes. The city is simply arranged at the scale of a human stride. That is not nostalgia. It is a practical way to spend less of life waiting for a light to change.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "People walk when the walk is shorter than the alternative and the path does not treat them as an obstacle."
		}, {
			...
			correctIndex: 2,
			explanation: "Proximity — a grocer, stop, school, and shade nearby — is described as the real luxury."
		}]
	},
	{
		id: "myth-multitasking",
		title: "The Myth of Multitasking",
		description: "Doing two demanding things at once is usually just switching — and switching has a cost.",
		category: "Education",
		difficulty: "beginner",
		readingTime: 5,
		author: "Priya Nair",
...
University work rewards this kind of patience because the difficult part is rarely typing. It is noticing the structure of someone else’s argument, and then building your own. That noticing needs a quiet corridor in the mind.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The passage argues that the mind switches, and each return to a task has a restart cost."
		}, {
			...
			correctIndex: 2,
			explanation: "The honest method described is serial work: one task, then notes, then a genuine break."
		}]
	},
	{
		id: "shape-memory",
		title: "Materials That Remember Their Shape",
		description: "Some metals and polymers can return to a trained form — a quiet kind of intelligence in matter.",
		category: "Science",
		difficulty: "advanced",
		readingTime: 7,
		author: "Kenji Mori",
...
The idea is larger than a clever metal. It suggests that objects can carry a stored instruction. The instruction is not software. It is geometry waiting for a cue. In a world that loves disposable devices, a material that can return — on purpose — feels like a different relationship with stuff.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "Different temperatures favor different atomic arrangements, so heat can restore a trained shape."
		}, {
			id: "shape-memory-q2",
			...
			correctIndex: 0,
			explanation: "A stent-like implant can travel collapsed and expand with body heat."
		}]
	},
	{
		id: "code-switching",
		title: "Language, Identity, and Code-Switching",
		description: "People often change how they speak to match a room. That shift can be skill, pressure, or both.",
		category: "Culture",
		difficulty: "advanced",
		readingTime: 7,
		author: "Amara Lewis",
...
The healthiest reading is double. Switching can help someone {{belong}} without abandoning a first language. It can also signal that institutions still have a narrow idea of what a “professional” voice is allowed to sound like. A serious language education would teach the skill and question the ranking at the same time.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The essay describes shifting register, dialect, or language according to context."
		}, {
			...
			correctIndex: 0,
			explanation: "The close argues we should teach the skill of switching and also question why some voices are ranked higher."
		}]
	},
	{
		id: "design-for-repair",
		title: "Designing for Repair, Not Replacement",
		description: "A product that can be opened, diagnosed, and fixed has a different relationship with time.",
		category: "Technology",
		difficulty: "intermediate",
		readingTime: 6,
		author: "Eva Holm",
...
There is a quiet dignity in mending. It is slower than a new box on the doorstep. It also teaches a more accurate story about machines: they are assemblies, not magic, and assemblies can be known.`,
		comprehension: [{
			...
			correctIndex: 1,
			explanation: "The opening says products often fail in a small way and are then treated as finished."
		}, {
			...
			correctIndex: 0,
			explanation: "Modularity lets one part be replaced so the rest of the device can continue."
		}]
	}
];
var topicOptions = [
...
function filterArticles(input) {
	...
	return articles.filter((article) => {
		...
		if (input.difficulty && input.difficulty !== "all" && article.difficulty !== input.difficulty) return false;
		if (!query) return true;
		const vocab = article.vocabulary.map((item) => item.word).join(" ");
		return `${article.title} ${article.description} ${article.category} ${vocab}`.toLowerCase().includes(query);
	});
}
function relatedArticles(article, limit = 3) {
	return articles.filter((item) => item.id !== article.id).sort((a, b) => {
		const aScore = (a.category === article.category ? 2 : 0) + (a.difficulty === article.difficulty ? 1 : 0);
		return (b.category === article.category ? 2 : 0) + (b.difficulty === article.difficulty ? 1 : 0) - aScore;
	}).slice(0, limit);
}
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BlwYcoG0.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "max-w-md text-sm leading-6 break-words text-muted-foreground",
...
function bumpActivity(activity, field) {
	const key = todayKey();
...
var useAppStore = create()(persist((set, get) => ({
	...
	removeWord: (id) => {
		set((state) => ({ savedWords: state.savedWords.filter((word) => word.id !== id) }));
	},
	setWordStatus: (id, status) => {
		set((state) => ({
			savedWords: state.savedWords.map((word) => word.id === id ? {
				...word,
				status
			} : word),
			...withStreak(state)
	...
	openArticle: (id) => {
		set((state) => ({
			lastArticleId: id,
			openedArticleIds: state.openedArticleIds.includes(id) ? state.openedArticleIds : [...state.openedArticleIds, id]
		}));
	},
	completeArticle: (id) => {
...
var styles_default = "/assets/styles-WB_XUMED.css";
var APP_NAME = "WordBridge";
var Route$8 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "WordBridge helps university students learn English vocabulary in context through reading, a personal notebook, and focused practice."
			},
			{
				name: "theme-color",
				content: "#172554"
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ThemeProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
				...
				toastOptions: { className: "!bg-surface !text-foreground !border-border !shadow-[var(--wb-shadow-md)]" }
			})] }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	});
}
var $$splitComponentImporter$7 = () => import("./routes-BEoB0NYS.mjs");
var Route$7 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$7, "component"),
	head: () => ({ meta: [{ title: "WordBridge — Read. Understand. Remember." }] })
});
var $$splitComponentImporter$6 = () => import("../_-Cpeqxav_.mjs");
var Route$6 = createFileRoute("/$")({
	component: lazyRouteComponent($$splitComponentImporter$6, "component"),
	head: () => ({ meta: [{ title: "Page not found — WordBridge" }] })
});
var $$splitComponentImporter$5 = () => import("./articles-Dp5bVjYW.mjs");
var Route$5 = createFileRoute("/articles")({
	validateSearch: (search) => ({
		q: typeof search.q === "string" ? search.q : void 0,
		topic: typeof search.topic === "string" ? search.topic : void 0,
		level: typeof search.level === "string" ? search.level : void 0
	}),
	component: lazyRouteComponent($$splitComponentImporter$5, "component"),
	head: () => ({ meta: [{ title: "Explore articles — WordBridge" }] })
});
var $$splitComponentImporter$4 = () => import("./practice-DeoHWImT.mjs");
var Route$4 = createFileRoute("/practice")({
	component: lazyRouteComponent($$splitComponentImporter$4, "component"),
	head: () => ({ meta: [{ title: "Practice — WordBridge" }] })
});
var $$splitComponentImporter$3 = () => import("./profile-Cun2Ift7.mjs");
var Route$3 = createFileRoute("/profile")({
	component: lazyRouteComponent($$splitComponentImporter$3, "component"),
	head: () => ({ meta: [{ title: "Profile — WordBridge" }] })
});
var $$splitComponentImporter$2 = () => import("./progress-BpZxgNpG.mjs");
var Route$2 = createFileRoute("/progress")({
	component: lazyRouteComponent($$splitComponentImporter$2, "component"),
	head: () => ({ meta: [{ title: "Progress — WordBridge" }] })
});
var $$splitComponentImporter$1 = () => import("./vocabulary-C0MBRaLX.mjs");
var Route$1 = createFileRoute("/vocabulary")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: "Vocabulary notebook — WordBridge" }] })
});
var $$splitComponentImporter = () => import("./article._id-Dlb-gD2x.mjs");
...
var rootRouteChildren = {
	...
	SplatRoute: Route$6.update({
		id: "/$",
		path: "/$",
		getParentRoute: () => Route$8
	}),
	ArticlesRoute: Route$5.update({
		id: "/articles",
		path: "/articles",
		getParentRoute: () => Route$8
	}),
	PracticeRoute: Route$4.update({
		id: "/practice",
		path: "/practice",
		getParentRoute: () => Route$8
	}),
	...
	VocabularyRoute: Route$1.update({
		id: "/vocabulary",
		path: "/vocabulary",
		getParentRoute: () => Route$8
	}),
...
//#endregion
export { useAppStore as a, filterArticles as c, topicOptions as d, selectProgress as i, getArticleById as l, Route as n, useHydrated as o, Route$5 as r, articles as s, router_exports as t, relatedArticles as u };
